...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  void saveUserData(LoginResponseEntity entity) {
    UserData user = entity.toUserData();
    _sharedPrefsHelper.userData = user;
    _secureStorageHelper.saveToken(entity.token);
  }
}
